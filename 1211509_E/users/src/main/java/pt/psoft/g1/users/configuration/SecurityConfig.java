...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        return username -> {
            System.out.println("🔥 [UDS] loadUserByUsername chamado com: " + username);

            User user = userRepo.findByUsername(username)
                    .orElseThrow(() -> new UsernameNotFoundException(format("User: %s, not found", username)));

            System.out.println("🔥 [UDS] User encontrado = " + user);
            System.out.println("🔥 [UDS] Password no User = " + user.getPassword());
            System.out.println("🔥 [UDS] Authorities = " + user.getAuthorities());
