...
public class Lending {
     ...
     * */
    public Lending(String book, String readerDetails, int seq, int lendingDuration, int fineValuePerDayInCents){
        try {
            this.isbn = Objects.requireNonNull(book);
            this.readerNumber = Objects.requireNonNull(readerDetails);
    ...
    public static Lending newBootstrappingLending(String book,
        ...
        try {
            ...
            lending.readerNumber = Objects.requireNonNull(readerDetails);
        }catch (NullPointerException e){
            throw new IllegalArgumentException("Null objects passed to lending");
        }
