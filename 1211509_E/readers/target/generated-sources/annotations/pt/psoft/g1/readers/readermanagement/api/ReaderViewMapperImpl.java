...
public class ReaderViewMapperImpl extends ReaderViewMapper {
    ...
    public ReaderView toReaderView(ReaderDetails readerDetails) {
        ...
        readerView.setEmail( map( readerDetailsReaderEmail( readerDetails ) ) );
    ...
    @Override
    public ReaderViewAMQP toReaderViewAMQP(ReaderDetails readerDetails) {
        if ( readerDetails == null ) {
            return null;
        }
        ...
        readerViewAMQP.setEmail( map( readerDetailsReaderEmail( readerDetails ) ) );
        readerViewAMQP.setFullName( map( readerDetailsReaderName( readerDetails ) ) );
        readerViewAMQP.setBirthDate( map( readerDetailsBirthDateBirthDate( readerDetails ) ) );
        readerViewAMQP.setPhoneNumber( map( readerDetails.getPhoneNumber() ) );
        readerViewAMQP.setGdprConsent( readerDetails.isGdprConsent() );
        readerViewAMQP.setInterestList( mapInterestList( readerDetails.getInterestList() ) );
        readerViewAMQP.setMarketingConsent( readerDetails.isMarketingConsent() );
        readerViewAMQP.setThirdPartySharingConsent( readerDetails.isThirdPartySharingConsent() );

        readerViewAMQP.setPhoto( generatePhotoUrl(readerDetails) );
    ...
    public List<ReaderView> toReaderView(Iterable<ReaderDetails> readerList) {
        ...
        for ( ReaderDetails readerDetails : readerList ) {
            list.add( toReaderView( readerDetails ) );
        }
    ...
    private String readerDetailsReaderEmail(ReaderDetails readerDetails) {
        if ( readerDetails == null ) {
            return null;
        }
    ...
    private String readerDetailsReaderName(ReaderDetails readerDetails) {
        if ( readerDetails == null ) {
            return null;
        }
        Reader reader = readerDetails.getReader();
