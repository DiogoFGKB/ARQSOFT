package pt.psoft.g1.books.genremanagement.infrastructure.repositories.impl;
...
public interface SpringDataGenreRepository extends GenreRepository, GenreRepoCustom, CrudRepository<Genre, Integer> {
    ...
    @Override
    @Query("SELECT new pt.psoft.g1.books.bookmanagement.services.GenreBookCountDTO(g.genre, COUNT(b))" +
            "FROM Genre g " +
