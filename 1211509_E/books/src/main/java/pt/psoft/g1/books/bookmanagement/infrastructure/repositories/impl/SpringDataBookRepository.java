package pt.psoft.g1.books.bookmanagement.infrastructure.repositories.impl;
...
import pt.psoft.g1.books.bookmanagement.model.Isbn;
import pt.psoft.g1.books.bookmanagement.repositories.BookRepository;
...
class BookRepoCustomImpl implements BookRepoCustom {
    ...
    @Override
    public List<Book> searchBooks(pt.psoft.g1.books.shared.services.Page page, SearchBooksQuery query)
    {
